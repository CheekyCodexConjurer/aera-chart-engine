...
This file is the overview. Detailed contracts are split into `docs/` and indexed by `docs/INDEX.md`.
...
Details: `docs/performance-contracts.md`, `docs/responsiveness-slos.md`.
...
Details: `docs/interaction-model.md`, `docs/replay-semantics.md`.
...
Details: `docs/redraw-invalidation-rules.md`.
...
Details: `docs/diagnostics-failure-surfaces.md`.
