...
This file hosts the detailed role definitions moved out of `AGENTS.md` to keep it under the 500-line cap.
Rationale: these roles govern chart-engine internal ownership and review boundaries, which are out of scope for quant-lab.

## Architecture Agent
**Responsibilities**
- Owns `architecture.md` (architecture map) and `docs/architecture-overview.md` (system-wide invariants).
...
**Primary artifacts**
- `architecture.md`, `docs/architecture-overview.md`, and system diagrams.
...
**Can change alone**
- Documentation updates to `architecture.md` and `docs/architecture-overview.md`.
